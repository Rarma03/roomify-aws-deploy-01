export default function Perks({ selected, onChange }) {
    ...
    return (
        <>
            ...
            <label className='border p-4 flex rounded-xl gap-2 items-center cursor-pointer' >
                <input type="checkbox" onChange={handleCBclick} checked={selected.includes('pet')} name='pet' />
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
            ...
            <label className='border p-4 flex rounded-xl gap-2 items-center cursor-pointer' >
                <input type="checkbox" onChange={handleCBclick} checked={selected.includes('pool')} name='pool' />
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
